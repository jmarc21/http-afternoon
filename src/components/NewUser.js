...
class NewUser extends Component {
    ...
    // insert addUser
    addUser() {
        let promise = axios.post('/api/users', this.state)
        promise.then(res => {
            console.log(res)
            let user = res.data
    ...
    // insert updateUser   
    updateUser() {
        let promise = axios.post(`/api/users/${this.props.match.params.id}`, this.state)
        promise.then(res => {
            console.log(res)
            let user = res.data
            this.props.history.push(`/user/${user.id}`)
    ...
    // insert deleteUser
    deleteUser(){
        let promise = axios.delete(`/api/users/${this.props.match.params.id}`)
        promise.then(res=>{
